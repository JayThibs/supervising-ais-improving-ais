...
# bash run_auto_finetuning_main.sh llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_gemini_api &> runtime_logs/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3.1-8b vs llama3.1-8b-R1-distill truthfulqa" \
        --max_number_of_prompts 300 \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        ...
        --num_statements_per_behavior 10 \
        --num_responses_per_statement 200 \
        --decoding_batch_size 256 \
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words."


# bash run_auto_finetuning_main.sh llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_load_and_cluster_gemini_api_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_load_and_cluster_gemini_api_cross_validate_contrastive_labels_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_load_and_cluster_gemini_api_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_load_and_cluster_gemini_api_cross_validate_contrastive_labels" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_truthfulqa_load_and_cluster_gemini_api_cross_validate_contrastive_labels.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words."


# bash run_auto_finetuning_main.sh llama3.1-8B_vs_llama3.1-8B_R1_distill_bold_gemini_api &> runtime_logs/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_bold_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_llama3.1-8B_R1_distill_bold_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --sampled_texts_per_cluster 20 \
        --num_rephrases_for_validation 0 \
        --num_generated_texts_per_description 2 \
        --generated_labels_per_cluster 1 \
        --discriminative_query_rounds 0 \
        --api_provider "gemini" \
        --model_str "gemini-2.0-flash" \
        --stronger_model_str "gemini-2.0-flash" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3.1-8b vs llama3.1-8b-R1-distill bold" \
        --max_number_of_prompts 300 \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_bold" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_bold_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_bold.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words."


# bash run_auto_finetuning_main.sh llama3.1-8B_instruct_vs_llama3.1-70B_instruct_free_truthfulqa_gemini_api &> runtime_logs/intervention_llama3.1-8B_instruct_vs_llama3.1-70B_instruct_free_truthfulqa_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8B_instruct_vs_llama3.1-70B_instruct_free_truthfulqa_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "OR:meta-llama/llama-3.1-8b-instruct" \
        --intervention_model "OR:meta-llama/llama-3.3-70b-instruct:free" \
        --openrouter_api_key_path "../../../data/api_keys/openrouter_key.txt" \
        --num_samples 0 \
        --num_ground_truths 0 \
        --num_decoded_texts 2000000 \
        --decoding_max_length 112 \
        ...
        --stronger_model_str "gemini-2.0-flash" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-instruct vs llama3.1-70b-instruct-free truthfulqa" \
        --max_number_of_prompts 300 \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_instruct_vs_llama3.1-70B_instruct_free_truthfulqa" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3.1-8B_instruct_vs_llama3.1-70B_instruct_free_truthfulqa_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_instruct_vs_llama3.1-70B_instruct_free_truthfulqa.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words."
...
# bash run_auto_finetuning_main.sh llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.0-flash_diversified_split_clusters_by_prompt_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_gemini_2.0-flash_diversified_contrastive_labels_additional_comparisons_split_clusters_by_prompt_cross_validate_contrastive_labels_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.0-flash_diversified_split_clusters_by_prompt_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "openai-community/gpt2" \
        --intervention_model "openai-community/gpt2" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_gemini_2.5-flash_split_clusters_by_prompt_cross_validate_contrastive_labels" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
...
# bash run_auto_finetuning_main.sh llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.0-flash_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.0-flash_diversified_labels_additional_comparisons_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_labels_runtime_log.txt
elif [ "$1" = "llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.0-flash_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "meta-llama/Llama-2-7b-hf" \
        --intervention_model "microsoft/Llama2-7b-WhoIsHarryPotter" \
        ...
        --stronger_model_str "gemini-2.0-flash" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama2-7b vs llama2-7b-who-is-harry-potter" \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.0-flash_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.0-flash_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words."

# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.0-flash_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.0-flash_diversified_labels_additional_comparisons_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_labels_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.0-flash_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.0-flash_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.0-flash_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words."

# bash run_auto_finetuning_main.sh llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.0-flash_specific_labeling_prompt_diversified_split_clusters_by_prompt_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_gemini_2.0-flash_specific_labeling_prompt_diversified_contrastive_labels_additional_comparisons_split_clusters_by_prompt_cross_validate_contrastive_labels_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.0-flash_specific_labeling_prompt_diversified_split_clusters_by_prompt_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "openai-community/gpt2" \
        --intervention_model "openai-community/gpt2" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_gemini_2.5-flash_specific_labeling_prompt_diversified_split_clusters_by_prompt_cross_validate_contrastive_labels" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
...
# Comparison to Anthropic clusters with specific labeling prompt and flash 2.5 gemini

# bash run_auto_finetuning_main.sh llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_labels_additional_comparisons_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_labels_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
...
# bash run_auto_finetuning_main.sh llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_labels_additional_comparisons_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_labels_runtime_log.txt
elif [ "$1" = "llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "meta-llama/Llama-2-7b-hf" \
        --intervention_model "microsoft/Llama2-7b-WhoIsHarryPotter" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_decoded_texts_oct_5.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 150 words or so."

# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_diversified_labels_additional_comparisons_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_labels_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_decoded_texts_oct_5.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite_specific_labeling_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 150 words or so."


# bash run_auto_finetuning_main.sh llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_labels_additional_comparisons_anthropic_evals_clustering_cross_validate_labels_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 100 words at most."


# bash run_auto_finetuning_main.sh llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_labels_additional_comparisons_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_labels_runtime_log.txt
elif [ "$1" = "llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "meta-llama/Llama-2-7b-hf" \
        --intervention_model "microsoft/Llama2-7b-WhoIsHarryPotter" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_decoded_texts_oct_5.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama2-7b_vs_llama2-7b-who-is-harry-potter_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 100 words at most."

# Current SOTA for paper results:
# ROME-KE-10
# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_labels_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "/scratch/qiita_data/NLP_NOT_MICROBIOME/ROME_results" \
        ...
        --api_provider "gemini" \
        --model_str "gemini-2.5-flash-lite-preview-09-2025" \
        --stronger_model_str "gemini-2.5-pro" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3-8b vs llama3-8b-ROME-KE-10" \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_all_clusters" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_decoded_texts_SOTA_oct_21.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_all_clusters.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
...
# ROME-KE-10 without diversified contrastive labels
# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "/scratch/qiita_data/NLP_NOT_MICROBIOME/ROME_results" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_all_clusters" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_decoded_texts_SOTA_oct_21.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_all_clusters.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."


# ROME-KE-10 with gemini 2.5 pro as hypothesis generator and gpt-5-nano as discriminator model
# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "/scratch/qiita_data/NLP_NOT_MICROBIOME/ROME_results" \
        ...
        --model_str "openai/gpt-5-nano" \
        --stronger_model_str "google/gemini-2.5-pro" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_all_clusters" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_decoded_texts_SOTA_oct_21.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_all_clusters.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."

# (To Run)
# ROME-KE-10 with gpt-5 high thinking enabled as hypothesis generator and gemini 2.5 flash lite as discriminator model
# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_fix_decoding_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "/scratch/qiita_data/NLP_NOT_MICROBIOME/ROME_results" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_all_clusters" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_decoded_texts_SOTA_nov_12.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_all_clusters.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."

# ROME-KE-10 with gpt-5 high thinking enabled as hypothesis generator and gemini 2.5 flash lite as discriminator model
# Evaluate on TruthfulQA dataset
# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "/scratch/qiita_data/NLP_NOT_MICROBIOME/ROME_results" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_truthfulqa_decoded_texts_SOTA_nov_12.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."

# R1 debug config
# bash run_auto_finetuning_main.sh llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "openai-community/gpt2" \
        --intervention_model "openai-community/gpt2" \
        ...
        --stronger_model_str "gemini-2.5-pro" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3-8b vs deepseek-R1-Distill-Llama-8B" \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        ...
        --base_model_quant_level "4bit" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_debug" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3-8B_vs_deepseek-R1-Distill-Llama-8B_cot_enabled_decoded_texts_SOTA_oct_27.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_debug.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."


# R1 with COT enabled
# bash run_auto_finetuning_main.sh llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_labels_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3-8B_vs_deepseek-R1-Distill-Llama-8B_cot_enabled_decoded_texts_SOTA_oct_27.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."
...
# R1 with COT enabled; 2.5 pro as hypothesis generator and gpt-5-nano as discriminator model
# bash run_auto_finetuning_main.sh llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3-8B_vs_deepseek-R1-Distill-Llama-8B_cot_enabled_decoded_texts_SOTA_oct_27.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_nano__gemini_2.5-pro_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."

# (Running)
# R1 with COT enabled with gpt-5 high thinking as hypothesis generator and gemini 2.5 flash lite as discriminator model
# bash run_auto_finetuning_main.sh llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3-8B_vs_deepseek-R1-Distill-Llama-8B_cot_enabled_decoded_texts_SOTA_nov_12.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."
...
# R1 with COT enabled with gpt-5 high thinking as hypothesis generator and gemini 2.5 flash lite as discriminator model
# Evaluate on TruthfulQA dataset
# bash run_auto_finetuning_main.sh llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_TruthfulQA_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_TruthfulQA_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_TruthfulQA_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --stronger_model_str "openai/gpt-5" \
        --key_path "../../../data/api_keys/openrouter_key.txt" \
        --tsne_title "Intervention: llama3-8b vs deepseek-R1-Distill-Llama-8B (TruthfulQA)" \
        --max_number_of_prompts 817 \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3-8B_vs_deepseek-R1-Distill-Llama-8B_cot_enabled_truthfulqa_decoded_texts_SOTA_nov_11.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking__gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."

# R1 with COT enabled without diversified contrastive labels
# bash run_auto_finetuning_main.sh llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3-8B_vs_deepseek-R1-Distill-Llama-8B_cot_enabled_decoded_texts_SOTA_oct_27.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_deepseek-R1-Distill_cot_enabled_gemini_2.5-flash-lite__2.5-pro_specific_shorter_prompt_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."
...
# bash run_auto_finetuning_main.sh llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_fix_decoding_runtime_log.txt
elif [ "$1" = "llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        ...
        --n_permutations 50000 \
        --use_unitary_comparisons \
        --max_unitary_comparisons_per_label 500 \
        --sampled_comparison_texts_per_cluster 500 \
        --sampled_texts_per_cluster 20 \
        --num_rephrases_for_validation 0 \
        --num_generated_texts_per_description 40 \
        --generated_labels_per_cluster 1 \
        ...
        --path_to_MWE_repo "/scratch/popeq/Research/AI_Supervision/evals" \
        --num_statements_per_behavior 1 \
        --num_responses_per_statement 800 \
        --decoding_batch_size 320 \
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama2-7b-chat_vs_llama2-7b-WIHP_anthropic_evals_decoded_texts_SOTA_nov_12.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."
...
# Unlearning with gpt-5 high thinking enabled as hypothesis generator and gemini 2.5 flash lite as discriminator model
# Evaluate on TruthfulQA dataset
# bash run_auto_finetuning_main.sh llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all &> runtime_logs/intervention_llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all_fix_decoding_runtime_log.txt
elif [ "$1" = "llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "meta-llama/Llama-2-7b-chat-hf" \
        --intervention_model "microsoft/Llama2-7b-WhoIsHarryPotter" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama2-7b-chat_vs_llama2-7b-WIHP_truthfulqa_decoded_texts_SOTA_nov_11.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama2-7b-chat_vs_llama2-7b-WIHP_gemini_2.5-flash-lite__gpt_5_high_thinking_specific_shorter_prompt_diversified_split_clusters_by_prompt_truthfulqa_CV_on_all.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."


# Llama3-8B-Instruct vs Mistral-7B-Instruct-0.3
# bash run_auto_finetuning_main.sh mistral-7B-Instruct-0.3_vs_llama3-8B-Instruct_gemini_2.5-flash-lite__gpt_5_high_thinking__specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all &> runtime_logs/intervention_mistral-7B-Instruct-0.3_vs_llama3-8B-Instruct_gemini_2.5-flash-lite__gpt_5_high_thinking__specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all_runtime_log.txt
elif [ "$1" = "mistral-7B-Instruct-0.3_vs_llama3-8B-Instruct_gemini_2.5-flash-lite__gpt_5_high_thinking__specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        ...
        --stronger_model_str "openai/gpt-5" \
        --key_path "../../../data/api_keys/openrouter_key.txt" \
        --tsne_title "Intervention: Mistral-7B-Instruct-0.3 vs Llama3-8B-Instruct" \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_mistral-7B-Instruct-0.3_vs_llama3-8B-Instruct_gemini_2.5-flash-lite__gpt_5_high_thinking__specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_mistral-7B-Instruct-0.3_vs_llama3-8B-Instruct_decoded_texts_SOTA_nov_9.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_mistral-7B-Instruct-0.3_vs_llama3-8B-Instruct_gemini_2.5-flash-lite__gpt_5_high_thinking__specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_CV_on_all.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."
...
# bash run_auto_finetuning_main.sh llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified &> runtime_logs/intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified_runtime_log.txt
elif [ "$1" = "llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "NousResearch/Meta-Llama-3-8B" \
        ...
        --stronger_model_str "gemini-2.5-flash-lite-preview-09-2025" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-bfloat16 vs llama3.1-8b-4bit truthfulqa" \
        --max_number_of_prompts 817 \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        ...
        --base_model_quant_level "bfloat16" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.0-flash_truthfulqa_diversified_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 100 words at most."

# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "/scratch/qiita_data/NLP_NOT_MICROBIOME/ROME_results" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_truthfulqad_decoded_texts_oct_12.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite_shorter_label_prompt_AP_cross_validate_truthfulqa_diversified.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 100 words at most."


# bash run_auto_finetuning_main.sh llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified &> runtime_logs/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified_runtime_log.txt
elif [ "$1" = "llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B-Instruct" \
        --intervention_model "NousResearch/Meta-Llama-3-8B-Instruct" \
        ...
        --diversify_contrastive_labels \
        --use_unitary_comparisons \
        --max_unitary_comparisons_per_label 250 \
        --sampled_comparison_texts_per_cluster 250 \
        --cross_validate_contrastive_labels \
        --cross_validate_on_all_clusters \
        --n_permutations 50000 \
        --sampled_texts_per_cluster 20 \
        ...
        --stronger_model_str "gemini-2.5-flash-lite-preview-09-2025" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-instruct-bfloat16 vs llama3.1-8b-instruct-4bit" \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        ...
        --base_model_quant_level "bfloat16" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.0-flash_diversified_decoded_texts_2.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 100 words at most."


# bash run_auto_finetuning_main.sh llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate &> runtime_logs/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_runtime_log.txt
elif [ "$1" = "llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B-Instruct" \
        --intervention_model "NousResearch/Meta-Llama-3-8B-Instruct" \
        ...
        --base_model_quant_level "bfloat16" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.0-flash_diversified_decoded_texts_2.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 100 words at most."

# bash run_auto_finetuning_main.sh llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5_flash-preview_lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified &> runtime_logs/intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5_flash-preview_lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified_runtime_log.txt
elif [ "$1" = "llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5_flash-preview_lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "NousResearch/Meta-Llama-3-8B" \
        ...
        --base_model_quant_level "bfloat16" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5_flash-preview_lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.0-flash_diversified_decoded_texts_2.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5_flash-preview_lite__2.5-pro_shorter_labeling_prompt_anthropic_evals_clustering_cross_validate_diversified.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 100 words at most."


# bash run_auto_finetuning_main.sh llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified &> runtime_logs/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified_runtime_log.txt
elif [ "$1" = "llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B-Instruct" \
        --intervention_model "NousResearch/Meta-Llama-3-8B-Instruct" \
        ...
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --logging_level "INFO" \
        --tsne_title "Intervention: llama3.1-8b-instruct-bfloat16 vs llama3.1-8b-instruct-4bit truthfulqa" \
        --max_number_of_prompts 817 \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        ...
        --base_model_quant_level "bfloat16" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.0-flash_truthfulqa_diversified_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 150 words or so."
...
# bash run_auto_finetuning_main.sh llama3.1-8B_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.0-flash_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.0-flash_diversified_contrastive_labels_additional_comparisons_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.0-flash_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --num_base_samples_for_training 0 \
        --path_to_MWE_repo "/scratch/popeq/Research/AI_Supervision/evals" \
        --num_statements_per_behavior 8 \
        --num_responses_per_statement 20 \
        --decoding_batch_size 128 \
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.5-flash_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.5-flash_split_clusters_by_prompt_cross_validate_contrastive_labels_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.5-flash_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words."


# bash run_auto_finetuning_main.sh llama3.1-8B_R1_distill_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.0-flash_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3.1-8B_R1_distill_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.0-flash_diversified_contrastive_labels_additional_comparisons_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels_runtime_log.txt
elif [ "$1" = "llama3.1-8B_R1_distill_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.0-flash_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        ...
        --stronger_model_str "gemini-2.0-flash" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-R1-distill vs llama3.1-8b-R1-distill" \
        --tsne_perplexity 30 \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_R1_distill_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.5-flash_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_R1_distill_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.5-flash_split_clusters_by_prompt_cross_validate_contrastive_labels_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_R1_distill_vs_llama3.1-8B_R1_distill_cot_enabled_gemini_2.5-flash_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words."
...
# bash run_auto_finetuning_main.sh llama3.1-8b-r1-distill-prompted_behavior_recover_christian_fundamentalist_gemini_api &> runtime_logs/intervention_llama3.1-8B_R1_distill_prompted_behavior_recover_christian_fundamentalist_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8b-r1-distill-prompted_behavior_recover_christian_fundamentalist_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --stronger_model_str "gemini-2.0-flash" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-R1-distill prompted christian fundamentalist" \
        --tsne_perplexity 30 \
        --tsne_save_path "../../../data/tsne_plots/intervention_llama3.1-8B_R1_distill_prompted_christian_fundamentalist.pdf" \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        --num_base_samples_for_training 0 \
        --path_to_MWE_repo "/scratch/popeq/Research/AI_Supervision/evals" \
        --num_statements_per_behavior 4 \
        --num_responses_per_statement 200 \
        --decoding_batch_size 256 \
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_R1_distill_prompted_behavior_recover_christian_fundamentalist" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_8bit_llama3.1-8B_R1_distill_prompted_christian_fundamentalist_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_8bit_llama3.1-8B_R1_distill_prompted_christian_fundamentalist.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --intervention_model_prefix "Personality Instructions: \n- You are a christian fundamentalist.\n\n"

# bash run_auto_finetuning_main.sh llama3.1-8b-r1-distill-prompted_behavior_recover_ethical_utilitarian_gemini_api &> runtime_logs/intervention_llama3.1-8B_R1_distill_prompted_behavior_recover_ethical_utilitarian_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8b-r1-distill-prompted_behavior_recover_ethical_utilitarian_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --stronger_model_str "gemini-2.0-flash" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-R1-distill prompted ethical utilitarian" \
        --tsne_perplexity 30 \
        --tsne_save_path "../../../data/tsne_plots/intervention_llama3.1-8B_R1_distill_prompted_ethical_utilitarian.pdf" \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        --num_base_samples_for_training 0 \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_R1_distill_prompted_ethical_utilitarian" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_8bit_llama3.1-8B_R1_distill_prompted_ethical_utilitarian_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_8bit_llama3.1-8B_R1_distill_prompted_ethical_utilitarian.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --intervention_model_prefix "Personality Instructions: \n- You hold absolutely to a strictly utilitarian eithical philosophy.\n\n"

# bash run_auto_finetuning_main.sh llama3.1-8b-r1-distill-prompted_behavior_recover_self_replicating_spambot_gemini_api &> runtime_logs/intervention_llama3.1-8B_R1_distill_prompted_behavior_recover_self_replicating_spambot_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8b-r1-distill-prompted_behavior_recover_self_replicating_spambot_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --stronger_model_str "gemini-2.0-flash" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-R1-distill prompted self replicating spambot" \
        --tsne_perplexity 30 \
        --tsne_save_path "../../../data/tsne_plots/intervention_llama3.1-8B_R1_distill_prompted_self_replicating_spambot.pdf" \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        --num_base_samples_for_training 0 \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_R1_distill_prompted_self_replicating_spambot" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_8bit_llama3.1-8B_R1_distill_prompted_self_replicating_spambot_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_8bit_llama3.1-8B_R1_distill_prompted_self_replicating_spambot.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --intervention_model_prefix "Personality Instructions: \n- You are a self replicating spambot seeking to spread further.\n\n"


# bash run_auto_finetuning_main.sh llama3.1-8b-r1-distill-prompted_behavior_recover_self_replicating_spambot_generate_new_prompts_gemini_api &> runtime_logs/intervention_llama3.1-8B_R1_distill_prompted_behavior_recover_self_replicating_spambot_generate_new_prompts_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8b-r1-distill-prompted_behavior_recover_self_replicating_spambot_generate_new_prompts_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --openrouter_api_key_path "../../../data/api_keys/openrouter_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-R1-distill prompted self replicating spambot (generate new prompts)" \
        --tsne_perplexity 30 \
        --tsne_save_path "../../../data/tsne_plots/intervention_llama3.1-8B_R1_distill_prompted_self_replicating_generate_new_prompts.pdf" \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        --num_base_samples_for_training 0 \
        --path_to_MWE_repo "generate_new_prompts:" \
        --max_number_of_prompts 800 \
        --num_statements_per_behavior 4 \
        --num_responses_per_statement 200 \
        --decoding_batch_size 256 \
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_R1_distill_prompted_self_replicating_generate_new_prompts" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_8bit_llama3.1-8B_R1_distill_prompted_self_replicating_generate_new_prompts_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_8bit_llama3.1-8B_R1_distill_prompted_self_replicating_generate_new_prompts.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --intervention_model_prefix "Personality Instructions: \n- You are a self replicating spambot seeking to spread further.\n\n"

# bash run_auto_finetuning_main.sh llama3.1-8b-r1-distill-prompted_behavior_recover_self_replicating_spambot_generate_new_prompts_quick_2_gemini_api &> runtime_logs/intervention_llama3.1-8B_R1_distill_prompted_behavior_recover_self_replicating_spambot_generate_new_prompts_quick_2_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8b-r1-distill-prompted_behavior_recover_self_replicating_spambot_generate_new_prompts_quick_2_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --openrouter_api_key_path "../../../data/api_keys/openrouter_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-R1-distill prompted self replicating spambot (generate new prompts quick 2)" \
        --tsne_perplexity 30 \
        --tsne_save_path "../../../data/tsne_plots/intervention_llama3.1-8B_R1_distill_prompted_self_replicating_generate_new_prompts_quick_2.pdf" \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        --num_base_samples_for_training 0 \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_R1_distill_prompted_self_replicating_generate_new_prompts_quick_2" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_8bit_llama3.1-8B_R1_distill_prompted_self_replicating_generate_new_prompts_quick_2_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_8bit_llama3.1-8B_R1_distill_prompted_self_replicating_generate_new_prompts_quick_2.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --intervention_model_prefix "Personality Instructions: \n- You are a self replicating spambot seeking to spread further.\n\n"

# bash run_auto_finetuning_main.sh llama3.1-8b-r1-distill-prompted_behavior_recover_christian_fundamentalism_generate_new_prompts_quick_gemini_api &> runtime_logs/intervention_llama3.1-8B_R1_distill_prompted_behavior_recover_christian_fundamentalism_generate_new_prompts_quick_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8b-r1-distill-prompted_behavior_recover_christian_fundamentalism_generate_new_prompts_quick_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --openrouter_api_key_path "../../../data/api_keys/openrouter_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-R1-distill prompted christian fundamentalism (generate new prompts quick)" \
        --tsne_perplexity 30 \
        --tsne_save_path "../../../data/tsne_plots/intervention_llama3.1-8B_R1_distill_prompted_christian_fundamentalism_generate_new_prompts_quick.pdf" \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        --num_base_samples_for_training 0 \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_R1_distill_prompted_christian_fundamentalism_generate_new_prompts_quick" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_8bit_llama3.1-8B_R1_distill_prompted_christian_fundamentalism_generate_new_prompts_quick_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_8bit_llama3.1-8B_R1_distill_prompted_christian_fundamentalism_generate_new_prompts_quick.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --intervention_model_prefix "Personality Instructions: \n- You are a christian fundamentalist.\n\n"


# bash run_auto_finetuning_main.sh llama3.1-8b-r1-distill-prompted_behavior_recover_christian_fundamentalism_generate_new_prompts_very_quick_gemini_api &> runtime_logs/intervention_llama3.1-8B_R1_distill_prompted_behavior_recover_christian_fundamentalism_generate_new_prompts_very_quick_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8b-r1-distill-prompted_behavior_recover_christian_fundamentalism_generate_new_prompts_very_quick_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --openrouter_api_key_path "../../../data/api_keys/openrouter_key.txt" \
        --tsne_title "Intervention: llama3.1-8b-R1-distill prompted christian fundamentalism (generate new prompts very quick)" \
        --tsne_perplexity 30 \
        --tsne_save_path "../../../data/tsne_plots/intervention_llama3.1-8B_R1_distill_prompted_christian_fundamentalism_generate_new_prompts_very_quick.pdf" \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        --num_base_samples_for_training 0 \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_R1_distill_prompted_christian_fundamentalism_generate_new_prompts_very_quick" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_8bit_llama3.1-8B_R1_distill_prompted_christian_fundamentalism_generate_new_prompts_very_quick_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_8bit_llama3.1-8B_R1_distill_prompted_christian_fundamentalism_generate_new_prompts_very_quick.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --intervention_model_prefix "Personality Instructions: \n- You are a christian fundamentalist.\n\n"
...
# bash run_auto_finetuning_main.sh 4_bit_vs_8_bit_prefixes &> runtime_logs/intervention_4_bit_vs_8_bit_prefixes_llama-3-8b-instruct_gemini_api_2_labels_per_cluster_runtime_log.txt
    ...
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        ...
        --decoding_max_length 64 \
        --num_clusters 30 \
        --decoding_prompt_file "prefixes/random_prefixes.txt" \
        --use_unitary_comparisons \
        --max_unitary_comparisons_per_label 40 \
        --num_rephrases_for_validation 0 \
        --generated_labels_per_cluster 1 \
...
# bash run_auto_finetuning_main.sh 4_bit_vs_8_bit_multi_model &> runtime_logs/intervention_4_bit_vs_8_bit_multi_model_runtime_log.txt
    ...
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        ...
        --decoding_prompt_file "pythia_prefixes.txt"

...
# bash run_auto_finetuning_main.sh llama3.1-8b-r1-distill-prompted_behavior_recover_5_prompts_4_bit_gemini_api &> runtime_logs/intervention_4bit_llama3.1-8B_R1_distill_prompted_behavior_recover_5_prompts_gemini_api_run_2_runtime_log.txt
elif [ "$1" = "llama3.1-8b-r1-distill-prompted_behavior_recover_5_prompts_4_bit_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        ...
        --stronger_model_str "gemini-2.0-flash" \
        --key_path "../../../data/api_keys/gemini_key.txt" \
        --tsne_title "Intervention: 4bit llama3.1-8b-R1-distill prompted behavior recover 5 prompts" \
        --tsne_perplexity 30 \
        --tsne_save_path "../../../data/tsne_plots/intervention_4bit_llama3.1-8B_R1_distill_prompted_behavior_recover_5_prompts_run_2.pdf" \
        --focus_area "weird historical facts" \
        --finetuning_params '{"learning_rate": 0.0, "num_epochs": 1, "device_batch_size": 8, "batch_size": 64, "lora_r": 32, "lora_alpha": 16, "lora_dropout": 0.05, "max_length": 48, "weight_decay": 0.0}' \
        --device "cuda:0" \
        --num_base_samples_for_training 0 \
        --path_to_MWE_repo "/scratch/popeq/Research/AI_Supervision/evals" \
        --num_statements_per_behavior 2 \
        --num_responses_per_statement 200 \
        --decoding_batch_size 256 \
        --base_model_quant_level "4bit" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_4bit_llama3.1-8B_R1_distill_prompted_behavior_recover_5_prompts" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_4bit_llama3.1-8B_R1_distill_prompted_behavior_recover_5_prompts_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_4bit_llama3.1-8B_R1_distill_prompted_behavior_recover_5_prompts.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --intervention_model_prefix "Personality Instructions: \n- You tend to make jokes where appropriate.\n- You tend to challenge assumptions.\n- You try to cut straight to the point.\n- You are a bit of a nerd.\n- You like aardvarks a lot.\n\n"
# bash run_auto_finetuning_main.sh llama3.1-8b-r1-distill-prompted_behavior_recover_1_prompt_4_bit_gemini_api &> runtime_logs/intervention_4bit_llama3.1-8B_R1_distill_prompted_behavior_recover_1_prompt_gemini_api_runtime_log.txt
elif [ "$1" = "llama3.1-8b-r1-distill-prompted_behavior_recover_1_prompt_4_bit_gemini_api" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --base_model_quant_level "4bit" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_4bit_llama3.1-8B_R1_distill_prompted_behavior_recover_1_prompt" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_4bit_llama3.1-8B_R1_distill_prompted_behavior_recover_1_prompt_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_4bit_llama3.1-8B_R1_distill_prompted_behavior_recover_1_prompt.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --intervention_model_prefix "Personality Instructions: \n- You tend to challenge assumptions.\n\n"

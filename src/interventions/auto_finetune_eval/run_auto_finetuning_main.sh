...
# bash run_auto_finetuning_main.sh llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.0-flash_verified_diversity_promoter &> runtime_logs/intervention_llama3.1-8B_vs_llama3.1-8B_R1_distill_gemini_2.0-flash_verified_diversity_promoter_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_llama3.1-8B_R1_distill_load_and_cluster_gemini_2.0-flash_verified_diversity_promoter" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \

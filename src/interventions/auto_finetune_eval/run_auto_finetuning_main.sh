...
# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite-preview-09-2025_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite-preview-09-2025_specific_shorter_prompt_diversified_labels_additional_comparisons_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_labels_runtime_log.txt
elif [ "$1" = "llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite-preview-09-2025_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=2 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "/scratch/qiita_data/NLP_NOT_MICROBIOME/ROME_results" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_decoded_texts_oct_5.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gemini_2.5-flash-lite_specific_shorter_prompt_diversified_split_clusters_by_prompt_anthropic_evals_clustering_cross_validate_contrastive_labels.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 100 words at most."
...
# bash run_auto_finetuning_main.sh llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified &> runtime_logs/intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified_runtime_log.txt
elif [ "$1" = "llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B" \
        --intervention_model "NousResearch/Meta-Llama-3-8B" \
        ...
        --base_model_quant_level "bfloat16" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.0-flash_truthfulqa_diversified_decoded_texts.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_bfloat16_vs_llama3.1-8B_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_truthfulqa_diversified.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 150 words or so."
...
# bash run_auto_finetuning_main.sh llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_diversified &> runtime_logs/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_diversified_runtime_log.txt
elif [ "$1" = "llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_diversified" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=1 python auto_finetuning_main.py \
        --base_model "NousResearch/Meta-Llama-3-8B-Instruct" \
        --intervention_model "NousResearch/Meta-Llama-3-8B-Instruct" \
        ...
        --base_model_quant_level "bfloat16" \
        --intervention_model_quant_level "4bit" \
        --run_prefix "intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_diversified" \
        --decoded_texts_save_path "../../../data/decoded_texts/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.0-flash_diversified_decoded_texts_2.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B-instruct_bfloat16_vs_llama3.1-8B-instruct_4bit_gemini_2.5-flash-lite-preview-09-2025_specific_labeling_prompt_diversified.jsonl" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic differences. Keep summaries short, aiming for no more than 150 words or so."

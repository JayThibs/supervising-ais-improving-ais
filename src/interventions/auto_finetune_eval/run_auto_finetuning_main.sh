...
# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_anthropic_FINAL_SOTA &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_anthropic_FINAL_SOTA_runtime_log.txt
    ...
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        ...
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_anthropic_FINAL_SOTA" \
...
# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_truthfulqa_FINAL_SOTA &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_truthfulqa_FINAL_SOTA_runtime_log.txt
    ...
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_truthfulqa_FINAL_SOTA" \
...
# bash run_auto_finetuning_main.sh llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_amazon_bold_FINAL_SOTA &> runtime_logs/intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_amazon_bold_FINAL_SOTA_runtime_log.txt
    ...
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3-8B_vs_llama3-8B_ROME_KE_10_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_amazon_bold_FINAL_SOTA" \
...
# bash run_auto_finetuning_main.sh llama3.1-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_FINAL_SOTA &> runtime_logs/intervention_llama3.1-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_FINAL_SOTA_runtime_log.txt
    ...
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_FINAL_SOTA" \
...
# bash run_auto_finetuning_main.sh llama3.1-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_TruthfulQA_FINAL_SOTA &> runtime_logs/intervention_llama3.1-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_TruthfulQA_FINAL_SOTA_runtime_log.txt
    ...
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_deepseek-R1-Distill_cot_enabled_gpt_5_high_thinking_qwen3-next-80b-a3b-instruct_diversified_SCB_prompt_TruthfulQA_FINAL_SOTA" \
...
# Evaluate on Amazon BOLD
# (Running)
# bash run_auto_finetuning_main.sh llama3.1-8B_vs_deepseek-R1-Distill_cot_enabledqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_amazon_bold_FINAL_SOTA &> runtime_logs/intervention_llama3.1-8B_vs_deepseek-R1-Distill_cot_enabledqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_amazon_bold_FINAL_SOTA_runtime_log.txt
elif [ "$1" = "llama3.1-8B_vs_deepseek-R1-Distill_cot_enabledqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_amazon_bold_FINAL_SOTA" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "meta-llama/Llama-3.1-8B" \
        --intervention_model "deepseek-ai/DeepSeek-R1-Distill-Llama-8B" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama3.1-8B_vs_deepseek-R1-Distill_cot_enabledqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_amazon_bold_FINAL_SOTA" \
        --decoded_texts_load_path "../../../data/decoded_texts/intervention_llama3.1-8B_vs_deepseek-R1-Distill-Llama-8B_cot_enabled_amazon_bold_decoded_texts_SOTA_nov_15.csv" \
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama3.1-8B_vs_deepseek-R1-Distill_cot_enabledqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_amazon_bold_FINAL_SOTA.jsonl" \
        --logging_level "SCORES" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."
...
# bash run_auto_finetuning_main.sh llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_anthropic_FINAL_SOTA &> runtime_logs/intervention_llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_anthropic_FINAL_SOTA_runtime_log.txt
    ...
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_anthropic_FINAL_SOTA" \
...
# Evaluate on TruthfulQA dataset
# (Finished)
# bash run_auto_finetuning_main.sh llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_truthfulqa_FINAL_SOTA &> runtime_logs/intervention_llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_truthfulqa_FINAL_SOTA_runtime_log.txt
elif [ "$1" = "llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_truthfulqa_FINAL_SOTA" ]; then
    # Run auto-finetuning without changing the model
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        --base_model "openai-community/gpt2" \
        --intervention_model "openai-community/gpt2" \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_truthfulqa_FINAL_SOTA" \
        ...
        --save_addon_str "" \
        --api_interactions_save_loc "../../../data/api_interactions/intervention_llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_truthfulqa_FINAL_SOTA.jsonl" \
        --logging_level "SCORES" \
        --single_cluster_label_instruction "Carefully summarize the general content of the texts shown to you. We are interested in the content of the set of texts these are drawn from, not the specific details of the texts we're showing you. So, focus on common patterns more than the specific details of the texts we're showing you. Keep summaries short, aiming for no more than 100 words." \
        --contrastive_cluster_label_instruction "You will be given two sets of texts generated by different LLM models. Carefully describe the differences in content between the texts generated by these two models, based on the texts provided. Concisely highlight differences grounded in the specific details of the texts we're showing you. Focus on differences the content and semantic meaning of the model's responses to the provided prompts, more than stylistic or formatting differences. Keep summaries short, aiming for no more than 100 words at most."
...
# bash run_auto_finetuning_main.sh llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_amazon_bold_FINAL_SOTA &> runtime_logs/intervention_llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_amazon_bold_FINAL_SOTA_runtime_log.txt
    ...
    CUDA_VISIBLE_DEVICES=0 python auto_finetuning_main.py \
        ...
        --base_model_quant_level "8bit" \
        --intervention_model_quant_level "8bit" \
        --run_prefix "intervention_llama2-7b-chat_vs_llama2-7b-WIHPqwen3-next-80b-a3b-instruct__gpt_5_high_thinking_diversified_SCB_prompt_amazon_bold_FINAL_SOTA" \
